...
prediction::PredictConfig makePredictConfig(const PlannerConfig& config) {
  ...
  predict_config.max_velocity = config.max_velocity;
...
traj_opt::TrajOptConfig makeTrajOptConfig(const PlannerConfig& config) {
  ...
  optimizer_config.max_velocity = config.max_velocity;
  optimizer_config.max_acceleration = config.max_acceleration;
